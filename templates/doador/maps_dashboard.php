...
<head>
	<meta charset="UTF-8">
	<link rel="stylesheet" type="text/css" href="<?= url("templates/doador/css/maps/mapsstyle_default.css"); ?>">
	<link rel="stylesheet" media="screen and (max-width:480px)" href="<?= url("templates/doador/css/maps/mapsstyle480.css"); ?>">
	<link rel="stylesheet" media="screen and (min-width:481px) and (max-width:768px)" href="<?= url("templates/doador/css/maps/mapsstyle768.css"); ?>">
	<link rel="stylesheet" media="screen and (min-width:769px) and (max-width:1024px)" href="<?= url("templates/doador/css/maps/mapsstyle1024.css"); ?>">
	<link rel=stylesheet media="screen and (min-width: 1025px)" href="<?= url("templates/doador/css/maps/mapsstyle1025.css"); ?>">
...
<div class="form_description">
	<nav id="cabecalho">
		<a href="<?= url("doador/"); ?>"><img id="logo" src="<?= url("templates/images/logo_semnome.png"); ?>"></a>

		<a href="<?= url("doador/"); ?>"><img id="home" src="<?= url("templates/images/home.png"); ?>"></a>

		<a href="<?= url("doador/configuracao/".$_SESSION['cd_usu']);?>"><img id="config" src="<?= url("templates/images/configuracoes.png"); ?>"></a>

		<form id="form_filtro" action="<?= url("doador/mapa/0"); ?>" method="get" >
...
<div id="menuBottom">
	<nav>
		...
		<a href="<?= url("doador/configuracao/".$_SESSION['cd_usu']);?>">
